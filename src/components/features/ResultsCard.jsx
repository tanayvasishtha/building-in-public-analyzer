      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            <div className="text-sm text-gray-600 mb-1">Twitter Posts</div>
            <div className="text-2xl font-bold text-blue-700">{twitterPosts.toLocaleString()}</div>
          </div>
          
          <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
            <div className="text-sm text-gray-600 mb-1">GitHub Contributions</div>
            <div className="text-2xl font-bold text-indigo-700">{githubContributions.toLocaleString()}</div>
          </div>
        </div>
        
        <div className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-100">
          <div className="text-sm text-gray-600 mb-1">Building Ratio (Twitter:GitHub)</div>
          <div className="text-2xl font-bold text-purple-700">{buildingRatio}</div>
          <div className="text-sm text-gray-600 mt-1">{builderType}</div>
        </div>
